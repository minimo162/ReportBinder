...
for needed in ['ensureDiffPdfJs', 'fetchDiffPdfDocument', 'renderDiffPdfPage', 'buildDiffBrowserPage', 'diffBrowserPageCache', "new Worker(new URL('diff-worker.js?v=20260804_v7'"]:
...
for needed in ['id="diff-before-regions"', 'id="diff-after-regions"', 'canvas id="diff-before-base"', 'canvas id="diff-after-base"', 'app.js?v=20260804_v69', 'style.css?v=20260731_v53']:
...
if 'app.js?v=20260804_v69' not in html:
...
if str(runtime_info.get('version','')) != '2026.08.04.11':
...
for needed in ['MIN_LAYOUT_SCALE=.82', 'MAX_LAYOUT_SCALE=1.18',
               ...
               'cluster.lastX-cluster.firstX+1<=5', 'activeMinX',
