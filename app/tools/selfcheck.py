...
for needed in ['id="diff-before-regions"', 'id="diff-after-regions"', 'canvas id="diff-before-base"', 'canvas id="diff-after-base"', 'app.js?v=20260805_v77', 'style.css?v=20260804_v54']:
...
if 'app.js?v=20260805_v77' not in html:
...
if str(runtime_info.get('version','')) != '2026.08.05.22':
...
for needed in ['extractDiffPdfTextItems', 'buildNumericTextDiffResult',
               ...
               'diffPdfNumericSignature', 'diffPdfTextTemplatesMatch',
